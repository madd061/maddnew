  ...
  const job = schedule.scheduleJob('0 0 21 * * *', function () {
    ...
    if (questions.length > 0) {
      ...
      if (channel && channel.type === ChannelType.GuildText) {
        channel.send(`# ${allah.GuildName} Ailesi Günün Sorusu ${emojis.maddxCekilis} \n> \n> **${question}** \n> --------------------------------------------------------------------------------------------------------------- \n > *(Not:) Hakaret, Küfür, Troll amacı ile yapılan yanıtlar silinecektir ve kanaldan uzaklaştırma almanıza sebep olacaktır.!* ${emojis.maddxCeza} \n> \n> *Yanıtlarınızı Bekliyorum.* ${emojis.maddxRevu} \n> \n> *Hepinize Keyifli Vakitler Dilerimm.* ${emojis.maddxSaat} \n\n ||<@1216834493999087707>||`);
