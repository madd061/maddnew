    ...
    collector.on("collect", async (interaction) => {
         ...
         if (interaction.values[0] === "vip") {
            ...
            if(!uye.roles.cache.has(ayar.vipRole)) {
              ...
              interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişiye **Vip** rolü verildi.`, components: [], ephemeral: true });
            } else {
              ...
              interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişinin **Vip** rolü geri alındı.`, components: [], ephemeral: true });
            };
         }
         ...
         if (interaction.values[0] === "müzisyen") {
            ...
            if(!uye.roles.cache.has(ayar.müzisyenRole)) {
              ...
              interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişiye **Müzisyen** rolü verildi.`, components: [], ephemeral: true });
            } else {
              ...
              interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişinin **Müzisyen** rolü geri alındı.`, components: [], ephemeral: true });
            };
         }
        ...
        if (interaction.values[0] === "tasarımcı") {
            ...
            if(!uye.roles.cache.has(ayar.tasarımcıRole)) {
              ...
              interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişiye **Tasarımcı** rolü verildi.`, components: [], ephemeral: true });
            } else {
              ...
              interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişinin **Tasarımcı** rolü geri alındı.`, components: [], ephemeral: true });
            };
         }
        ...
        if (interaction.values[0] === "streamer") {
            ...
            if(!uye.roles.cache.has(ayar.streamerRole)) {
              ...
              interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişiye **Streamer** rolü verildi.`, components: [], ephemeral: true });
            } else {
              ...
              interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişinin **Streamer** rolü geri alındı.`, components: [], ephemeral: true });
            };
         }
         ...
         if (interaction.values[0] === "terapi") {
          ...
          if(!uye.roles.cache.has(ayar.terapistRole)) {
            ...
            interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişiye **Terapist** rolü verildi.`, components: [], ephemeral: true });
          } else {
            ...
            interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişinin **Terapist** rolü geri alındı.`, components: [], ephemeral: true });
          };
       }
        ...
        if (interaction.values[0] === "sorun") {
            ...
            if(!uye.roles.cache.has(ayar.sorunçözücüRole)) {
              ...
              interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişiye **Sorun Çözücü** rolü verildi.`, components: [], ephemeral: true });
            } else {
              ...
              interaction.reply({ content:`${maddxTik} Başarıyla ${uye}, isimli kişinin **Sorun Çözücü** rolü geri alındı.`, components: [], ephemeral: true });
            };
         }
        })
}
