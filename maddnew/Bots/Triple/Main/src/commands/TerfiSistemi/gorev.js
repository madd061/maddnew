...
const { maddxd2, maddxb2, maddxd1, maddxb3, maddxd3, maddxRed, maddxStaff } = require("../../../../src/configs/emojis.json")
...
module.exports = {
  ...
  **${maddxStaff} Selamlar ${member} Aşağıda Bulunan Menüden İstediğin 1 Görevi Alabilirsin!
      
  ${maddxStaff} Ses Görevini Alırsan 60 İla 300 Dakika Arası 10 Saatli Süreli Ses Görevi Verir
      
  ${maddxStaff} Mesaj Görevini Alırsan 300 İla 400 Mesaj Arası 10 Saatli Süreli Mesaj Görevi Verir
      
  ${maddxStaff} Taglı Görevini Alırsan 1 İla 5 Arası 10 Saatli Süreli Taglı Görevi Verir
          
  ${maddxStaff} Kayıt Görevini Alırsan 5 İla 20 Arası 10 Saatli Süreli Kayıt Görevi Verir

  ${maddxStaff} Yayın Görevini Alırsan 60 İla 300 Dakika Arası 10 Saatli Süreli Yayın Görevi Verir

  ${maddxStaff} Kamera Görevini Alırsan 60 İla 300 Dakika Arası 10 Saatli Süreli Kamera Görevi Verir
      
  ${maddxStaff} Görev Ödüllerini 20 Coin Olarak Verilir
