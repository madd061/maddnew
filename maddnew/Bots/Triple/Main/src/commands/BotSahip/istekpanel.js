...
const { maddxTik, maddxRed, maddxCekilis } = require("../../../../src/configs/emojis.json")
...
client.on('interactionCreate', async interaction => {
    ...
    if (interaction.customId === 'istek') {
        ...
        let s1 =  interaction.fields.getTextInputValue('isteksoru1');
            interaction.reply({content: `${maddxTik} İstek/Önerin Başarıyla iletildi.`, ephemeral: true});
        ...
        const sk1 = new TextInputBuilder()
            ...
            .setPlaceholder('Örn: madd bu işi biliyo :D.')
        ...
        interaction.reply({content: `${maddxTik} Şikayetin Başarıyla iletildi.`, ephemeral: true});
