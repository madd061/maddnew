...
client.on('interactionCreate', async interaction => {
    ...
    if(interaction.customId === "stbasvur") {
        ...
        let s3 = interaction.fields.getTextInputValue('ssoru3');
            interaction.reply({content: `${maddxTik} Streamer başvurun başarıyla alındı`, ephemeral: true});
        ...
        if(client.channels.cache.find(x => x.name == "streamer-log")) {
            ...
            await interaction.update({content:`> ${maddxTik} **Streamer Başvurusu Başarıyla Kabul Edildi!**\n> **Kabul Eden Yetkili:** ${interaction.user}`,components: []});
            ...
            await interaction.update({content:`> ${maddxRed} **Streamer Başvurusu Başarıyla Ret Edildi!**\n> **Ret Eden Yetkili:** ${interaction.user}`,components: []});
