...
module.exports = {
  ...
  collector.on("collect", async (button) => {
    ...
    if (button.customId === "ac") {
      ...
      data.tagMode = true;
      data.save();
      msg.edit({ content: `${maddxTik} Taglı Alım modu başarıyla **Aktif** edildi!`, embeds: [], components: [] });
    ...
    if (button.customId === "kapa") {
      ...
      data.tagMode = false;
      data.save();
      msg.edit({ content: `${maddxTik} Taglı Alım modu başarıyla **Deaktif** edildi!`, embeds: [], components: [] });
    }
