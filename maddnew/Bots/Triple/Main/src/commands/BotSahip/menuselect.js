...
const { maddxStar } = require("../../../../src/configs/emojis.json")
...
module.exports = {
  ...
  run: async (client, message, args, durum, kanal) => {
    ...
    **NOT:** \`Kayıtlı, kayıtsız olarak hepiniz bu kanalı görebilmektesiniz. Sunucumuz da everyone veya here atılmayacağından dolayı kesinlikle rollerinizi almayı unutmayın.\``,
            ...
            message.channel.send({ content: `${maddxStar} Aşağıda ki menüden **Burç** rollerinden dilediğinizi alabilirsiniz.`,
                    "components": [{
                        "type": 1, "components": [{
            ...
            message.channel.send({ content: `${maddxStar} Aşağıda ki menüden **Oyun** rollerinden dilediğinizi alabilirsiniz.`,
                    "components": [{
                        "type": 1, "components": [{
            ...
            message.channel.send({ content: `${maddxStar} Aşağıda ki menüden **Renk** rollerinden dilediğinizi alabilirsiniz.`,
                    "components": [{
                        "type": 1, "components": [{
            ...
            message.channel.send({ content: `${maddxStar} Aşağıda ki menüden **İlişki** rollerinden dilediğinizi alabilirsiniz.`,
                    "components": [{
                        "type": 1, "components": [{
            ...
            message.channel.send({ content: `${maddxStar} Aşağıda ki menüden **Takım** rollerinden dilediğinizi alabilirsiniz.`,
                    "components":[{
                        "type": 1, "components": [{
