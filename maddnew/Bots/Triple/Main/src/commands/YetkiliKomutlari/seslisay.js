...
const { maddxRed, maddxTik, maddxStar, maddxRevu, maddxOk } = require("../../../../src/configs/emojis.json")
...
${maddxStar} Sesli kanallarda toplam **${topses.size}** kişi var !

${maddxOk} Public odalarda **${members.filter(m => pubID.includes(m.voice.channel.parentId)).size}** kişi var !
${maddxOk} Ses kanallarında **${tagses.size}** taglı kullanıcı var !
${maddxOk} Ses kanallarında **${yetkili}** yetkili var !

${maddxOk} Ses kanallarında **${yayın.size}** kişi yayın yapıyor !
${maddxOk} Mikrofonu kapalı: **${mik}**
${maddxOk} Kulaklığı kapalı: **${kulak}**

${maddxRevu} **Top 3 kategori sırası;**
${topCategory || 'Boş'}
`)
