...
const { maddxRed, maddxTik, maddxSonsuz } = require("../../../../src/configs/emojis.json")
...
> ${maddxSonsuz} Toplam kayıt bilgisi: \`${data ? data.top : 0}\`
> ${maddxSonsuz} Toplam erkek kayıt bilgisi: \`${data ? data.erkek : 0}\`
> ${maddxSonsuz} Toplam kız kayıt bilgisi: \`${data ? data.kız : 0}\`
	`)] });
    }
    else if (args[0] === "top") {
