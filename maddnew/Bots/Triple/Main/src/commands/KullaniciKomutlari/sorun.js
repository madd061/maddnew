...
const {maddxKalp,maddxSonsuz,maddxCeza, maddxRed} = require("../../../../src/configs/emojis.json");
...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (lastTimestamp && (now - lastTimestamp) < cooldownAmount) {
        ...
        return message.channel.send(`> ${maddxRed} **Bu komutu tekrar kullanabilmek için <t:${endCooldown}:R> beklemelisin!**`);
    }
