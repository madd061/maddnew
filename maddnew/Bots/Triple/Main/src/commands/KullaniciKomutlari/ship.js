...
const {maddxKalp,maddxSonsuz,maddxCeza} = require("../../../../src/configs/emojis.json");
  ...
  run: async (client, message, args) => {
    ...
    collector.on('collect', async (interaction) => {
      if (interaction.customId === 'tanis') {
        await user2.send({
          content: `**Merhaba! ${user} seninle tanışmak istiyor.** ${maddxKalp} \n\n> **Sende tanışmak istiyorsan \`${allah.GuildName}\` sunucunda onunla tanışabilirsin.** ${maddxSonsuz} \n> **Eğer Bu durumdan şikayetçi olmaya başlarsan cyr0nix ile iletişime geç.**${maddxCeza}`,
