...
moment.locale("tr")
const { maddxRevu, maddxOk, maddxTik, maddxRed } = require("../../../src/configs/emojis.json")
  ...
  if (!oldState.channel && newState.channel) {
    ...
    channel.send({
      embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({ dynamic: true }) }).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 }))
        .setDescription(`
${maddxTik} ${newState.member} isimli kullanıcı bir sesli kanalına girdi.
  ...
  if (oldState.channel && !newState.channel) {
    ...
    channel.send({
      embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({ dynamic: true }) }).setThumbnail(oldState.member.displayAvatarURL({ dynamic: true, size: 2048 }))
        .setDescription(`
${maddxRed} ${oldState.member} isimli kullanıcı bir sesli kanalından ayrıldı.
...
`)]
  ...
  if (oldState.channel.id && newState.channel.id && oldState.channel.id != newState.channel.id) {
    ...
    channel.send({
      embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({ dynamic: true }) }).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 }))
        .setDescription(`
${maddxTik} ${newState.member} isimli kullanıcı bir sesli kanal değişimi yaptı.
...
`)]
  ...
  if (oldState.channel.id && oldState.selfMute && !newState.selfMute) {
    channel2.send({
      embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({ dynamic: true }) }).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 }))
        .setDescription(`
${maddxRed} ${newState.member} isimli kullanıcı bir sesli kanalda kendi susturmasını kaldırdı.
...
`)]
  ...
  if (oldState.channel.id && !oldState.selfMute && newState.selfMute) {
    channel2.send({
      embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({ dynamic: true }) }).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 }))
        .setDescription(`
${maddxTik} ${newState.member} isimli kullanıcı bir sesli kanalda kendini susturdu.
...
`)]
  ...
  if (oldState.channel.id && oldState.selfDeaf && !newState.selfDeaf) {
    channel2.send({
      embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({ dynamic: true }) }).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 }))
        .setDescription(`
${maddxRed} ${newState.member} isimli kullanıcı bir sesli kanalda kendi sağırlaştırmasını kaldırdı.
...
`)]
  ...
  if (oldState.channel.id && !oldState.selfDeaf && newState.selfDeaf) {
    channel2.send({
      embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({ dynamic: true }) }).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 }))
        .setDescription(`
${maddxTik} ${newState.member} isimli kullanıcı bir sesli kanalda kendini sağırlaştırdı.
